...
datafiles = {
    ...
    "four_tables_cnx_metadata": {
        ...
        "valid_file": True,
        "tables": [
            "input_connection_metadata",
            "ayx137028f06553292c2fbe34041601684b",
            "ayx6bc5d8e5e737c4dd07872b2bcf3ae2dd",
            "ayxc4ca4238a0b923820dcc509a6f75849b",
        ],
    ...
    "data_types_dataset": {
        "filename": "DataTypes.yxdb",
        "type": "yxdb",
        "valid_file": True,
        "tables": [],
        "notes": "contains all numeric data types, V_String, V_WString, and SpatialObj -- (missing String, WString, Blob)",
    },
    "data_types_sqlite": {
        "filename": "DataTypes.sqlite",
        "type": "sqlite",
        "valid_file": True,
        "tables": ["TableMcTableFace"],
        "notes": "contains all numeric data types, V_String, V_WString, and SpatialObj -- (missing String, WString, Blob)",
    },
}
